...
const configMigrations = {
    mongodb: {
        ...
        options: {
            // useNewUrlParser: true, // removes a deprecation warning when connecting // has now effect since node.js 4.0.0
            // useUnifiedTopology: true, // removes a deprecating warning when connecting // has now effect since node.js 4.0.0
