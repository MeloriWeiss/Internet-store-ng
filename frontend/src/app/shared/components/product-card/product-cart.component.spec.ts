...
describe('product card', () => {
  ...
  beforeEach(() => {
    ...
    const favouriteServiceSpy = jasmine.createSpyObj('FavouriteService', ['updateFavourite']);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {provide: FavouriteService, useValue: favouriteServiceSpy},
      ],
  ...
  it('should set value from product countInCart to count', () => {
  ...
  it('should not call navigate fot full card', () => {
    let routerSpy = TestBed.inject(Router) as jasmine.SpyObj<Router>;
